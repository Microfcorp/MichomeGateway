...
function createphoto(){
    postAjax('http://<?echo $_SERVER['HTTP_HOST'];?>/site/createphoto.php', "", function(d){alert("Успешно снято");});			    
}
...
function Start(resp){
	postAjax('http://<?echo $_SERVER['HTTP_HOST'];?>/michome/grafick.php?mode=1&'+resp, "", function(d){
