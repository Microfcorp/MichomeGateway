...
<html>
	<head>
        ...
        <script type="text/javascript">
			...
			const TagDisabledStartTime = ["^sts;", "^sds;", "^sde;", "^bt", "^pw"];
			const TagDisabledEndTime = ["^sts;", "^eds;", "^ede;", "^bt", "^pw"];
			const TagDisabledNDataTime = ["^bt", "^cbp;", "^pbp;", "^pw", "^spw;"];
			
			const StructRenameData = [[["^bt", "^pbp;"], "Данные при нажатии кнопки"], [["^pw", "^spw;"], "Данные при триггере пина"], ["^sts;", "Данные, при запуске системы"]];
			const StructRenameNData = [[["^bt", "^pbp;"], "Не поддерживается для событий с кнопкой"], [["^pw", "^spw;"], "Не поддерживается для событий триггера"], ["^sts;", "Данные, при выключении системы"]];
                ...
                <div class = "components">
					<div class = "components_alfa">
                        ...
                        <div style="display: none" id="sconst">
							<p style='color:#ff6b6b;'>Модификаторы условия (в названии)</p>
							...
							<p style='color:#ff6b6b;'>Чтение данных</p>
                            <p> ^cse; - Заменяет на тайм-аут выполнения</p>
							...
							<p style='color:#ff6b6b;'>Уведомления</p>
                            <p> ^sn_all_Привет, мир!; - Отправляет уведомление группе {all} с текстом {Привет, мир!}</p>
                            <p style='color:#ff6b6b;'>Условия</p>
							<p> ^usefalse; - ИНАЧЕ условия выполнять вне периода</p>
							<p> ^if_(0)>30; - Выполнить если {0} {>} {30}. (> < == !=)</p>
                            <p style='color:#ff6b6b;'>Действия с кнопкой</p>
							...
							<p style='color:#ff6b6b;'>Триггеры пинов</p>
							<p> ^spw; - Только в действиях с триггером пина! Заменяется на состояние вывода</p>
							<p> ^pw_192.168.1.34_5_1; - Выполнять при триггере пина на модуле {192.168.1.34}, с пином {5}, изменение состояния на {1}</p>
                            <p> ^pw_192.168.1.34_5; - Выполнять при триггере пина на модуле {192.168.1.34}, с пином {5}</p>
                            <p> ^pw_192.168.1.34; - Выполнять при триггере пина на модуле {192.168.1.34}</p> 							
							<?php
								$lastgr = "";
