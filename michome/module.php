...
<html>
	<head>
        ...
        function save(){
            ...
            if($_SERVER['HTTP_HOST'] == "192.168.1.42")
		...
		function CreateModule(mID, ip, type){
			...
			postAjax('api/setcmd.php?device='+ mID +'&cmd='+ 'getmoduleinfo', "GET", "", function(d){
				if(d.lastIndexOf("Ошибка") != -1){ //Если ошибка соединения
					...
					p3.innerHTML = "Версия системы Michome: " + MicVer;
					...
					//a11.href = "proxy.php?module=" + mID;
					a11.href = "http://" + ip;
					let a1 = document.createElement('p');
					a1.append(a11);
					let a21 = document.createElement('a');
					a21.innerHTML = "Управление StudioLight";
					a21.href = "studiolight.php?module=" + mID;
