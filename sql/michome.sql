...
CREATE TABLE `michom` (
  ...
  KEY `id_2` (`id`),
  KEY `date` (`date`)
) ENGINE=InnoDB AUTO_INCREMENT=1017868 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='Основная таблица данных';
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2024-10-07 13:10:10
-e 
